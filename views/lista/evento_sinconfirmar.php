<li class="list-group-item">
	...
	<a id="link" class="btn btn-danger pull-right" href="<?php echo '?view=confirmar&miembro='. $evento['nombre'] .'&mes=2&confirmado=2&fecha='. $evento['fecha'] .'&mes='. $mes .' ' ?>"><i class="fa fa-exchange" aria-hidden="true"></i></a>
